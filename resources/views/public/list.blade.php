    ...
    <div class="max-w-7xl mx-auto bg-white p-6 md:p-8 rounded-lg shadow-md">
        ...
        <div class="bg-blue-50 border border-blue-200 text-blue-600 px-4 py-3 rounded mb-6">
            <ul class="list-disc list-inside text-sm">
                <li>Using: views/public/list. First shot at a public view of resources. Can't get links to view:public.show/display to work.</li>
            </ul>
        </div>

        <div class="bg-black-50 border border-blue-200 px-4 py-3 rounded mb-6">
            <p class="text-1xl font-bold text-gray-900">Search:</p>
        </div>

        <div class="bg-black-50 border border-blue-200 px-4 py-3 rounded mb-6">
            <p class="text-1xl font-bold text-gray-900">Resources</p>
